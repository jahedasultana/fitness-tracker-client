		...
		<div className="flex flex-col px-6 py-8 space-y-6 rounded-xl sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-green-500 dark:text-gray-50">
			...
			<div className="flex space-x-2 sm:space-x-4">
				...
				<div className="space-y-2">
					...
					<p className="leading-snug">We understand that everyone’s fitness journey is unique. Our trainers will work with you to develop a customized training plan that fits your goals.</p>
				</div>
			</div>
		</div>
