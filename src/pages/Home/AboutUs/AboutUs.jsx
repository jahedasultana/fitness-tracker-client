...
const AboutUs = () => {
  return (
    <div className="my-20 bg-[#FFFFFF] dark:bg-[#1D232A]">
      ...
      <div>
        <section className="bg-gray-100 dark:bg-[#133c55] dark:text-gray-700">
          <div className="container flex flex-col-reverse mx-auto lg:flex-row rounded-2xl">
            <div className="flex flex-col px-6 py-8 space-y-6 rounded-xl sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 bg-[#133c55] text-gray-300 ">
            ...
            <div className="lg:w-1/2 xl:w-3/5 bg-gray-200 dark:bg-[#133c55]">
