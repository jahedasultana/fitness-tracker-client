...
const AllTrainerPage = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-16">
      {trainers.map((item) => (
       <div key={item._id} className="flex flex-col justify-center p-6 shadow-xl rounded-xl sm:px-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 border-2">
       <img src={item.image} alt="" className="w-32 h-32 mx-auto rounded-full bg-gray-500 dark:bg-gray-500 aspect-square" />
       <div className="space-y-4 text-center divide-y divide-gray-700 dark:divide-gray-300">
         <div className="my-2 space-y-1">
           ...
           <p className="px-5 text-xl font-semibold sm:text-base text-gray-400 dark:text-gray-600">{item.expertise}</p>
           <p className="px-5 text-xs sm:text-base text-gray-400 dark:text-gray-600"><span className="font-bold">Per Day Time:</span> {item.available_time}</p>
           <p className="px-5 text-xs sm:text-base text-gray-400 dark:text-gray-600"><span className="font-bold">Years of Experience: </span> {item.years_of_experience}</p>
         </div>
         ...
         <button className="btn w-full btn-active bg-violet-500 text-white font-bold mt-2 ">know More</button>
         </Link>
       </div>
     </div>
      ))}
