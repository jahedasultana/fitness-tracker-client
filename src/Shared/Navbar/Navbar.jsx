...
const Navbar = () => {
  ...
  return (
    ...
    <div className="navbar-start w-auto">
     ...
     <div className="font-pop font-bold lg:text-2xl  sm:flex items-center justify-center bg-gradient-to-r from-red-700 to-pink-400  text-transparent bg-clip-text">
     <span>
             <img
      ...
      <div className="gap-4">
        <Link to="/login">
          {user ? (
            <button
              onClick={logout}
              className="btn bg-gradient-to-r from-red-700 to-pink-500 text-white"
            >
              LogOut
            </button>
          ) : (
